...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886476943?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/SaiMun-cyber-403/Approval/main/F.txt").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+8801886576943?text=' + tks)
